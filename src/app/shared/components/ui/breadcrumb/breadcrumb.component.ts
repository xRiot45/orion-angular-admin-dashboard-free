...
export class ZardBreadcrumbItemComponent {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(
      breadcrumbItemVariants({ zType: this.zType(), zShape: this.zShape() }),
      this.class(),
    ),
  );
}
...
export class ZardBreadcrumbLinkComponent {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(breadcrumbLinkVariants({ zType: this.zType() }), this.class()),
  );
}
...
export class ZardBreadcrumbPageComponent {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(breadcrumbPageVariants({ zType: this.zType() }), this.class()),
  );
}
...
export class ZardBreadcrumbSeparatorComponent {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(breadcrumbSeparatorVariants({ zType: this.zType() }), this.class()),
  );
}
