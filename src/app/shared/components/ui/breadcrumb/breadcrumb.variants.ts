...
export const breadcrumbLinkVariants = cva(
  'flex items-center gap-1 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      zType: {
    ...
    variants: {
      zType: {
        ...
        current:
          ...
          'hover:text-foreground focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring',
      },
    },
    defaultVariants: {
      zType: 'default',
